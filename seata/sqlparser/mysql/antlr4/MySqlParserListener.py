...
class MySqlParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by MySqlParser#parameterMarker.
    def enterParameterMarker(self, ctx:MySqlParser.ParameterMarkerContext):
        pass

    # Exit a parse tree produced by MySqlParser#parameterMarker.
    def exitParameterMarker(self, ctx:MySqlParser.ParameterMarkerContext):
        pass
