...
from core.protocol.transaction.AbstractGlobalEndRequestResponseCodec import AbstractGlobalEndRequestCodec, \
    AbstractGlobalEndResponseCodec


class GlobalStatusRequestCodec(object):
...
class GlobalStatusResponseCodec(object):
